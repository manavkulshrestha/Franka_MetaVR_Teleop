# NOTE: run the setup.sh file from directory femtomega/ with "sh setup.sh"
import time
import cv2
import open3d as o3d
import numpy as np
from matplotlib import pyplot as plt
from pyorbbecsdk import Pipeline, AlignFilter, PointCloudFilter, OBStreamType, OBFormat, save_point_cloud_to_ply
